                ...
                <div class="card">
                    ...
                    <form action="update" method="post">
                       ...
                       <fieldset class="form-group">
                            <label>Employee ID</label> <input type="text" value= "${emp.empInfo.empId}" class="form-control" name="name" required="required">
                        </fieldset>
                   
 						<fieldset class="form-group">
                            <label>Employee Name</label> <input type="text" value="${emp.getName()}" class="form-control" name="name" required="required">
                        </fieldset>
